...
const DefaultProfilePicture = require("../assets/imgs/default_player.png");
const DefaultTeamLogo = require("../assets/imgs/default_team_logo.png");
const DefaultMatchImage = require("../assets/imgs/default_match_image.jpg");
