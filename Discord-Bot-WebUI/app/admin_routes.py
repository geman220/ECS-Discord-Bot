...
from app.models import (
    ...
    TemporarySubAssignment, player_teams
)
...
# -----------------------------------------------------------
# League Polls REMOVED 2026-07-21 — legacy reaction-emoji poll system
# (manage/create/results/close/delete + dead update_poll_response).
# Replaced by Surveys & Polls native Discord polls, which now support
# all-team-channel fan-out. The availability_api vote callbacks and the
# bot's send_league_poll path remain for any in-flight legacy polls;
# remove them (and the league_poll* tables) once none are active.
# -----------------------------------------------------------
