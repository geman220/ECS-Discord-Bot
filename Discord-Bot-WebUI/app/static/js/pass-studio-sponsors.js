            ...
            html: `
                <div class="text-left">
                    ...
                    <div class="flex items-center mb-4">
                        <input id="sponsor-create-loc" type="checkbox" class="w-4 h-4 text-primary-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-primary-500 dark:focus:ring-primary-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
