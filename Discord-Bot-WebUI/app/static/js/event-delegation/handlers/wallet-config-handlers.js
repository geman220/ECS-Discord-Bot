...
window.EventDelegation.register('validate-certificate', (element, event) => {
    ...
    window.Swal.fire({
        ...
        window.Swal.fire({
            ...
            html: `
                <div class="text-left">
                    <p><strong>Status:</strong> <span class="inline-flex items-center px-2 py-0.5 rounded-sm text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">Valid</span></p>
            ...
            if (data.status === 'ok') {
                resultDiv.innerHTML = `
                    <div class="flex items-center p-4 mb-3 rounded-lg bg-green-50 text-green-800 dark:bg-green-900/50 dark:text-green-300" data-alert>
                        <svg class="w-5 h-5 mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    ...
                    <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                        ...
                        <div class="space-y-2 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="inline-flex items-center px-2 py-0.5 rounded-sm text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-300">OK</span>
                            </div>
                            <div class="flex justify-between">
        ...
        .catch(error => {
            resultDiv.innerHTML = `
                <div class="flex items-start p-4 rounded-lg bg-red-50 text-red-800 dark:bg-red-900/50 dark:text-red-300" data-alert>
                    <svg class="w-5 h-5 mr-2 shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                    <div>
