 ...
 */
export function exportAnalytics(type, format) {
    // Show loading
 ...
 * Export role data
 */
export function exportRoleData() {
 ...
 * Export league data
 */
export function exportLeagueData() {
...
if (typeof window.InitSystem !== 'undefined') {
    window.InitSystem.register('userAnalytics', init, {
        requires: [],
        priority: 10
    });
}
