...
(function() {
    ...
    function setupEventListeners() {
        // Weeks count change handler
        const weeksCountInput = document.getElementById('weeks_count');
        if (weeksCountInput) {
            weeksCountInput.addEventListener('input', function() {
                updatePracticeWeekOptions();
                generateDefaultWeeks();
            });
        }

        // Practice weeks checkbox handler
        const practiceWeeksCheckbox = document.getElementById('enable-practice-weeks');
        if (practiceWeeksCheckbox) {
            practiceWeeksCheckbox.addEventListener('change', function() {
