...
class Player(db.Model):
    ...
    # Classic draft M/N balance (male vs not-male): NULL = derive from pronouns;
    # admins may set 'M'/'N' explicitly (classic_draft_service.derive_gender).
    # Never player-facing.
    balance_gender = db.Column(db.String(1), nullable=True)
