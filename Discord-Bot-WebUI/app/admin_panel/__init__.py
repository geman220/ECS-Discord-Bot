...
def _build_admin_search_index():
    ...
    items = [
        ...
        {'name': 'NAD Board', 'category': 'Users', 'description': 'Newly Acquired Drinkers — first-season players and shared scouting notes',
         'keywords': ['nad', 'nads', 'new players', 'newly acquired', 'scouting', 'draft pool', 'first season'],
         'url': url_for('admin_panel.nad_board'), 'icon': 'ti-user-plus'},
