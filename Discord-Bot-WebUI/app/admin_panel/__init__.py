...
def _build_admin_search_index():
    ...
    items = [
        ...
        # --- League Ops: League Management ---
        {'name': 'Season Builder', 'category': 'League Ops', 'subcategory': 'League Management',
        ...
        {'name': 'Current Schedule', 'category': 'League Ops', 'subcategory': 'League Management',
        ...
        {'name': 'All Seasons', 'category': 'League Ops', 'subcategory': 'League Management',
        ...
        {'name': 'All Teams', 'category': 'League Ops', 'subcategory': 'League Management',
        ...
        {'name': 'Coach Dashboard', 'category': 'League Ops', 'subcategory': 'League Management',
        ...
        # --- League Ops: Match Management ---
        {'name': 'Match Dashboard', 'category': 'League Ops', 'subcategory': 'Match Management',
        ...
        {'name': 'Leagues', 'category': 'League Ops', 'subcategory': 'Match Management',
        ...
        {'name': 'Match Verification', 'category': 'League Ops', 'subcategory': 'Match Management',
        ...
        {'name': 'Live Reporting', 'category': 'League Ops', 'subcategory': 'Match Management',
        ...
        # --- League Ops: Substitutes ---
        {'name': 'Manage Substitutes', 'category': 'League Ops', 'subcategory': 'Substitutes',
        ...
        {'name': 'Substitute Pools', 'category': 'League Ops', 'subcategory': 'Substitutes',
        ...
        # --- League Ops: Draft ---
        {'name': 'Draft Overview', 'category': 'League Ops', 'subcategory': 'Draft',
        ...
        {'name': 'Draft History', 'category': 'League Ops', 'subcategory': 'Draft',
        ...
        {'name': 'Draft Predictions', 'category': 'League Ops', 'subcategory': 'Draft',
        ...
        # --- League Ops: Pub League ---
        {'name': 'Pub League Orders', 'category': 'League Ops', 'subcategory': 'Pub League',
        ...
        # --- Members: Mobile App ---
        {'name': 'Mobile Features', 'category': 'Members', 'subcategory': 'Mobile App',
        ...
        {'name': 'Mobile Analytics', 'category': 'Members', 'subcategory': 'Mobile App',
        ...
        {'name': 'Mobile Users', 'category': 'Members', 'subcategory': 'Mobile App',
        ...
        {'name': 'Error Analytics', 'category': 'Members', 'subcategory': 'Mobile App',
        ...
        # --- Members: Store ---
        {'name': 'Store Management', 'category': 'Members', 'subcategory': 'Store',
        ...
        {'name': 'Store Items', 'category': 'Members', 'subcategory': 'Store',
        ...
        {'name': 'Store Orders', 'category': 'Members', 'subcategory': 'Store',
         'description': 'View and manage customer orders',
         'keywords': ['purchases', 'sales', 'fulfillment'],
         'url': url_for('admin_panel.store_orders'), 'icon': 'ti-list'},
        {'name': 'Store Analytics', 'category': 'Members', 'subcategory': 'Store',
        ...
        # --- Members: Engagement ---
        {'name': 'I-Spy Management', 'category': 'Members', 'subcategory': 'Engagement',
        ...
        {'name': 'I-Spy Analytics', 'category': 'Members', 'subcategory': 'Engagement',
        ...
        # --- Admin: Reports ---
        {'name': 'Reports Dashboard', 'category': 'Admin', 'subcategory': 'Reports',
        ...
        {'name': 'Feedback', 'category': 'Admin', 'subcategory': 'Reports',
        ...
        # --- Admin: Appearance ---
        {'name': 'Theme Settings', 'category': 'Admin', 'subcategory': 'Appearance',
        ...
        # --- Admin: System ---
        {'name': 'Feature Toggles', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'System Monitoring', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Cache Management', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'API Management', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'System Health', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Redis Management', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Docker Management', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Performance Monitor', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Security Dashboard', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Task Monitor', 'category': 'Admin', 'subcategory': 'System',
        ...
        {'name': 'Audit Logs', 'category': 'Admin', 'subcategory': 'System',
        ...
        # --- Wallet ---
        {'name': 'Apple Wallet Passes', 'category': 'Members', 'subcategory': 'Wallet',
        ...
        {'name': 'Player Eligibility', 'category': 'Members', 'subcategory': 'Wallet',
        ...
        {'name': 'Wallet Configuration', 'category': 'Members', 'subcategory': 'Wallet',
