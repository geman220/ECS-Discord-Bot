...
def _build_admin_search_index():
    ...
    items = [
        ...
        {'name': 'Reports Hub', 'category': 'Reports', 'description': 'Central hub for data reports and Excel exports',
         ...
         'url': url_for('admin_panel.reports_center'), 'icon': 'ti-report-analytics'},
        {'name': 'Player Stats Export', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.player_stats_report'), 'icon': 'ti-soccer-field'},
        {'name': 'Attendance Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.attendance_report'), 'icon': 'ti-calendar-check'},
        {'name': 'Player Movement Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.movement_report'), 'icon': 'ti-arrows-up-down'},
        {'name': 'Retention Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.retention_report'), 'icon': 'ti-users-group'},
        {'name': 'Roster History Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.roster_history_report'), 'icon': 'ti-history'},
        {'name': 'Leaderboards Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.leaderboards_report'), 'icon': 'ti-trophy'},
        {'name': 'Kit / Jersey Size Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.jersey_report'), 'icon': 'ti-shirt-sport'},
        {'name': 'Team Standings Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.standings_report'), 'icon': 'ti-table'},
        {'name': 'Discipline Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.discipline_report'), 'icon': 'ti-cards'},
        {'name': 'Contactability Report', 'category': 'Reports',
         ...
         'url': url_for('admin_panel.contactability_report'), 'icon': 'ti-address-book'},
        ...
        {'name': 'System Health', 'category': 'System', 'subcategory': 'Monitoring',
         ...
         'url': url_for('admin_panel.system_health_consolidated'), 'icon': 'ti-heartbeat'},
        ...
        {'name': 'Cache & Redis', 'category': 'System', 'subcategory': 'Infrastructure',
         ...
         'url': url_for('admin_panel.cache_redis_consolidated'), 'icon': 'ti-database'},
        ...
        {'name': 'Membership Passes', 'category': 'Apps & Engagement', 'subcategory': 'Wallet',
         ...
         'url': url_for('wallet_admin.passes_list'), 'icon': 'ti-id'},
        {'name': 'Pass Scanner', 'category': 'Apps & Engagement', 'subcategory': 'Wallet',
         ...
         'url': url_for('wallet_admin.scanner'), 'icon': 'ti-scan'},
        {'name': 'Pass Check-Ins', 'category': 'Apps & Engagement', 'subcategory': 'Wallet',
         ...
         'url': url_for('wallet_admin.checkins_list'), 'icon': 'ti-checkbox'},
        ...
        {'name': 'Pass Studio', 'category': 'Apps & Engagement', 'subcategory': 'Wallet',
         ...
         'url': url_for('pass_studio.index'), 'icon': 'ti-brush'},
        {'name': 'Wallet Setup Wizard', 'category': 'Apps & Engagement', 'subcategory': 'Wallet',
         ...
         'url': url_for('wallet_config.setup_wizard'), 'icon': 'ti-wand'},
        {'name': 'Wallet Diagnostics', 'category': 'Apps & Engagement', 'subcategory': 'Wallet',
         ...
         'url': url_for('wallet_config.diagnostics'), 'icon': 'ti-stethoscope'},
