...
@pytest.mark.asyncio
@patch("match_utils.fetch_espn_data")
@patch("match_utils.get_away_match")
async def test_get_next_match_away_game_with_opponent(
    mock_get_away_match, mock_fetch_espn_data
):
    mock_fetch_espn_data.side_effect = [
        {"team": {"nextEvent": []}},
        {
            "events": [
                {
                    "name": "Seattle Sounders FC at LAFC",
                    "date": "2024-02-24T21:30Z",
                    "id": "692606",
                    "competitions": [
                        {
                    ...
                    "links": [
                        {
                            "href": "https://www.espn.com/soccer/match/_/gameId/692606",
                            "rel": "summary",
                        },
                        {
                            "href": "https://www.espn.com/soccer/matchstats/_/gameId/692606",
                            "rel": "stats",
                        },
                        {
                            "href": "https://www.espn.com/soccer/commentary/_/gameId/692606",
                            "rel": "commentary",
                        },
                    ],
                }
    ...
    mock_get_away_match.return_value = (
        "Seattle Sounders FC at LAFC - 2024-02-24",
        "ticket_link",
    )
    ...
    expected_result = {
        ...
        "team_logo": None,
        "is_home_game": False,
        "match_summary_link": "https://www.espn.com/soccer/match/_/gameId/692606",
        "match_stats_link": "https://www.espn.com/soccer/matchstats/_/gameId/692606",
        "match_commentary_link": "https://www.espn.com/soccer/commentary/_/gameId/692606",
    }

    result = await get_next_match(None, "18966", opponent="Seattle Sounders FC")
    assert result == expected_result
